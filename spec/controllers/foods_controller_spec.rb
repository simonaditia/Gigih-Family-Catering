...
describe FoodsController do
    describe 'GET #index' do
        context 'with params[:id]' do
            it "populates an array of foods starting with the id" do
            nasi_uduk = create(:food, name: "Nasi Uduk")
            jus_mangga = create(:food, name: "Jus Mangga")
        ...
        context 'without params[:id]' do
            ...
            jus_mangga = create(:food, name: "Jus Mangga")
            get :index
            expect(assigns(:foods)).to match_array([nasi_uduk, jus_mangga])
            end
    ...
    describe 'POST #create' do  
        context "with valid attributes" do
            ...
            post :create, params: { food: attributes_for(:food) }
            expect(response).to redirect_to(foods_path(assigns[:food]))
            end
    ...
    describe 'PATCH #update' do
        ...
        context "with valid attributes" do
            ...
            patch :update, params: { id: @food, food: attributes_for(:food, name: 'Jus Mangga') }
            @food.reload
            expect(@food.name).to eq('Jus Mangga')
            end
    ...
    describe 'PATCH #update' do
        ...
        context 'with invalid attributes' do
            ...
            patch :update, params: { id: @food, food: attributes_for(:invalid_food, name: "Mie", price: "Seribu") }
            expect(@food.name).not_to eq('Mie')
            end
