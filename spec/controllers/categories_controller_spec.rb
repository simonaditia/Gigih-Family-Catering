...
describe CategoriesController do
  ...
  describe 'GET #index' do
    ...
    Food.create(name: "Jus Apel", description: "Jus Apel Segar", price: 10000, category: "Juice")
      juice = create(:category, name: "Juice")
      beverage = create(:category, name: "Beverage")
      get :index
      expect(assigns(:categories)).to match_array([juice, beverage])
    end
